...
import certifi         # Important to have specially working with MongoDB Database
...
class NetworkDataExtract():
    ...
    def insert_data_mongodb(self, records, database, collection):
        try:
            ...
            self.mongo_client = pymongo.MongoClient(MONGO_DB_URL)  # to connect the mongodb database
